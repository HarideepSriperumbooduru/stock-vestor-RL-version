...
class YahooFinanceProcessor:
    ...
    def calculate_turbulence(self, data, time_period=252):
        ...
        print("inside turulence calculation")
            ...
            for d in stock_splits_df['Date']:
                ...
                for t in data['date']:
                    ...
                    if str(d) == str(t):
                        ...
                        print("data is ", data.loc[line_count]['tic'])
                        row = data.loc[line_count]
                        if row['tic'] == tic:
                            # print("d is ", d, "and t is ", t, " and tic is ", data.loc[line_count]['tic'], 'mapped to ', tic)
                            # print('line_count is ', line_count)
                            ...
                            data.iloc[[line_count], [-1]] = stock_splits_df.loc[(stock_splits_df['Date'] == d)][
                                'Stock Splits']
                            # print("after updating")
                            # print(data.loc[[line_count]])
                            break
        try:

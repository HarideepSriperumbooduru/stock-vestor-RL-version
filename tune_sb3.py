  ...
  """
    ...
    def objective(self, trial: optuna.Trial):
        ...
        model = self.agent.get_model(
            self.model_name, model_kwargs=hyperparameters
        )
...
obj_SAC = TuneSB3Optuna(env_train=env_train, model_name='sac', env_trade=e_trade_gym, logging_callback=logging_callback, total_timesteps=50000)
obj_SAC.run_optuna()
obj_SAC.backtest()